...
// TODO: quitar el usuario de la url
calendarRouter.get('/all/user/:user_id', calendarController.get2DatesEvents)

// Post para añadir eventos al calendario
calendarRouter.post('/:day/user/:user_id', calendarController.addEventToDay)
