...
function Hero() {
    ...
    return (    
        <section className="pt-24 bg-gray-500 animate-fade-right animate-once animate-duration-[800ms] animate-ease-in border-b-2">
            <div className="px-12 mx-auto max-w-7xl">
                <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                    ...
                    <p className="px-0 mb-8 text-lg text-gray-700    md:text-xl lg:px-24">
                    ...
                    <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                        <a href="#_" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-orange-500 rounded-2xl sm:w-auto sm:mb-0">
                            Empieza ya
                            <svg className="w-4 h-4 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                        </a>
                        <a href="#_" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-gray-100 text-gray-700 rounded-2xl sm:w-auto sm:mb-0">
                            Más información
